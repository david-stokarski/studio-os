...
// Shadcn-style wrappers around Radix ContextMenu. Used by the preset browser
// to surface Rename / Move / Delete on each preset and folder via right-click.
// Styling intentionally mirrors components/ui/dropdown-menu.tsx so the two
// popovers feel like the same family.
