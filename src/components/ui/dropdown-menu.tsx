...
// Thin shadcn-style wrappers around Radix DropdownMenu primitives. Used by the
// preset browser to render the cascading folder → sub-folder → presets menus.
// Styling intentionally mirrors components/ui/select.tsx so the popover feels
